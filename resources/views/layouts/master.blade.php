...
<div class="wrapper">
 ...
 <!-- Navbar -->
 <nav class="main-header navbar navbar-expand navbar-white navbar-light " style="background:#74b9ff;">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
      <li class="nav-item">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a style="margin-top:50px;background:grey;color:white;" href="" class="nav-link">
              ...
              <p style="margin-left:7px;margin-top:25px;">
                Dedi Maulana
                <i style="margin-left:40px;" class="fas fa-angle-left right"></i>
              </p>
              </div>
            </a>
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="data_akun" class="nav-link">
